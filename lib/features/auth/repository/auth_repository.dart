...
import 'package:chat_app_staj/features/auth/screens/otp_screen.dart';
import 'package:chat_app_staj/features/auth/screens/user_information_screen.dart';
...
class AuthRepository{
  ...
  void saveUserDataToFirebase({
    ...
    try{
      ...
      String phoroUrl = "https://png.pngitem.com/pimgs/s/649-6490124_katie-notopoulos-katienotopoulos-i-write-about-tech-round.png";

      if(profilePic != null){
      phoroUrl= await ref.read(commonFirebaseStorageRepositoryProvider).storeFileToFirebase("profilePic/$uid", profilePic);
      }
      var user =UserModel(
          name: name,
          uid: uid,
